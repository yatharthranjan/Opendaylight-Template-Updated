package org.opendaylight.yang.gen.v1.urn.eu.virtuwind.reference.impl.rev150722 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "reference-impl";
    private final String namespace = "urn:eu:virtuwind:reference:impl";
    private final String revision = "2015-07-22";
    private final String resourcePath = "/META-INF/yang/reference-impl.yang";
