...
public abstract class AbstractReferenceModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractReferenceModule> implements eu.virtuwind.reference.impl.ReferenceModuleMXBean {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(eu.virtuwind.reference.impl.AbstractReferenceModule.class);
    ...
    public AbstractReferenceModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public AbstractReferenceModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractReferenceModule oldModule,java.lang.AutoCloseable oldInstance) {
    ...
    public boolean canReuseInstance(AbstractReferenceModule oldModule){
    ...
    public boolean isSame(AbstractReferenceModule other) {
        if (other == null) {
    ...
    if (o == null || getClass() != o.getClass()) { return false; }
        AbstractReferenceModule that = (AbstractReferenceModule) o;
