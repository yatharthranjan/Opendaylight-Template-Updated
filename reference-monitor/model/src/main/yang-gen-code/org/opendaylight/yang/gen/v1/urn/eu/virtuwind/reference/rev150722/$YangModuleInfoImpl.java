...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "reference";
    private final String namespace = "urn:eu:virtuwind:reference";
    private final String revision = "2015-07-22";
    private final String resourcePath = "/META-INF/yang/reference.yang";
