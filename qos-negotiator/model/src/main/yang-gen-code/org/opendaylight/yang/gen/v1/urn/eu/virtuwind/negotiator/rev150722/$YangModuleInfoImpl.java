...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "negotiator";
    private final String namespace = "urn:eu:virtuwind:negotiator";
    private final String revision = "2015-07-22";
    private final String resourcePath = "/META-INF/yang/negotiator.yang";
