...
public abstract class AbstractNegotiatorModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractNegotiatorModule> implements eu.virtuwind.negotiator.impl.NegotiatorModuleMXBean {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(eu.virtuwind.negotiator.impl.AbstractNegotiatorModule.class);
    ...
    public AbstractNegotiatorModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public AbstractNegotiatorModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractNegotiatorModule oldModule,java.lang.AutoCloseable oldInstance) {
    ...
    public boolean canReuseInstance(AbstractNegotiatorModule oldModule){
    ...
    public boolean isSame(AbstractNegotiatorModule other) {
        if (other == null) {
    ...
    if (o == null || getClass() != o.getClass()) { return false; }
        AbstractNegotiatorModule that = (AbstractNegotiatorModule) o;
